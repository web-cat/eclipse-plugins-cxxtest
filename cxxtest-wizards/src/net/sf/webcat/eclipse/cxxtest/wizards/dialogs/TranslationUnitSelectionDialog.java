...
public class TranslationUnitSelectionDialog extends ElementTreeSelectionDialog {
    ...
    private static final Class[] VALIDATOR_CLASSES = new Class[] { ITranslationUnit.class };
    ...
    private static final Class[] FILTER_CLASSES = new Class[] { ICModel.class, ICContainer.class, ICProject.class, ITranslationUnit.class };
    ...
    public TranslationUnitSelectionDialog(Shell parent) {
        ...
        setSorter(fSorter);
        addFilter(fFilter);
        setTitle("Header File Selection");
        setMessage("Choose a C++ header file:");
    }
}
