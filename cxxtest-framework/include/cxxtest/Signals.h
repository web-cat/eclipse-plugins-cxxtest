...
namespace CxxTest
{
    extern StringAppender	__cxxtest_sigmsg;
    extern StringAppender	__cxxtest_assertmsg;
	extern bool				__cxxtest_runCompleted;

	extern void __append_backtrace_xml(void** backtrace, bool filter, Appender& appender);
	extern void __append_backtrace_plain(void** backtrace, bool filter, Appender& appender);
...
#	define _TS_CATCH_SIGNAL( action ) \
	...
	const int __cxxtest_jmpmax = 256;
...
#define _TS_TRY_WITH_SIGNAL_PROTECTION \
	__cxxtest_last_abort_was_overflow = false; \
    __cxxtest_last_signal = 0; \
...
#define _TS_SIGNAL_CLEANUP \
    { CxxTest::__cxxtest_jmppos--; __cxxtest_sigmsg.clear(); }
